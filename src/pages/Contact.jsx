...
export default function Contact() {
  return (
    ...
    <link rel="stylesheet" href="styles.css" />
      ...
      <div class="container">
      <header class="header">
        <h1 id="title" class="text-center">Godfred's Survey Form</h1>
      ...
      <form id="survey-form">
        ...
        <div class="form-group">
          <p>Would you recommend others to learn at freeCodeCamp?</p>
          <label>
            <input
              name="user-recommend"
              value="definitely"
        ...
        <div class="form-group">
          <p>Identify your favorite feature of freeCodeCamp?</p>
